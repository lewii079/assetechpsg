...
export const SiteHeader = memo(SiteHeaderComponent);import { Link } from "@tanstack/react-router";
import { useState, useEffect, useRef, memo } from "react";
import { Menu, X, ChevronDown } from "lucide-react";
import logo from "@/assets/assetech-logo.png.asset.json";
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <nav className="hidden items-center gap-8 md:flex">
            ...
            >
              ...
              {servicesOpen && (
                <div className="absolute left-1/2 top-full z-50 mt-2 w-[560px] -translate-x-1/2 rounded-xl border border-border bg-background p-5 shadow-xl">
                  <div className="grid grid-cols-2 gap-6">
                    <div>
                      <p className="mb-2 text-xs font-semibold uppercase tracking-widest text-primary">Core services</p>
                      <ul className="space-y-1">
